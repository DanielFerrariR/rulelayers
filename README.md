...
Commit `.rulesync.company/` and `.rulesync.project/` (or your shared layers). Keep `.rulesync.user/` and the merged `.rulesync/` out of git — the merge includes personal overrides.
